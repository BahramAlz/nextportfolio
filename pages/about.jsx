              ...
              <div className="max-w-screen-md mt-10 animate__animated animate__backInLeft">
                <div className="w-86 mt-5 md:w-96">
                  <p className="mt-5">
                    ...
                    interactions, and creating minimalistic yet elegant
                    websites.
                  </p>
                  <p className="mt-5">
                  ...
                  <p className="mt-5">
                    ...
                    audience through daily website usage. It's like a canvas
                    where I can learn, code, and craft meaningful experiences
                    for users.
                  </p>
                  <p className="mt-5">
                    What excites me even more is that front-end development also
                    allows me to enhance my communication and leadership
                    abilities. I value these skills greatly and aspire to
                    further develop them. It's not just about coding; it's about
